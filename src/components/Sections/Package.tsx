      ...
      <section className="text-gray-600 body-font border-b border-gray-800">
        <div className="container max-w-5xl w-full pb-16 mx-auto flex py-12 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto mx-auto w-full mt-10 md:mt-0">
            <div className="text-gray-900 text-lg font-semibold title-font mb-5">
              @candypay/sdk -
              <span>
                <Link passHref href="/docs" className="px-2">
                  SDK Docs
                </Link>
              </span>
            </div>
            <button
              className="text-white bg-[#5344FF] border-0 py-2 px-8 focus:outline-none hover:brightness-90 rounded text-lg flex justify-center items-center h-10"
              onClick={mutate}
            >
              {isLoading ? (
